...
写入 Trunk **stable** 性能 SLA 的那组运行时旋钮（环境变量等）及其绑定的
`trunk-ref`（git SHA 或 tag）。测量取值与 Trunk 代码默认值 MUST 分列（流程纪律见
meta [[META-005]]）。接口声明见 [[API-011]]…[[API-013]]；示例 SLA：[[CON-SLA-016]]…[[CON-SLA-018]]。

## 双轨 / 装订术语（adopted）

> **非 SoT 正文** — adopted 指针。Canonical: [`../meta/glossary.md`](../meta/glossary.md)
> （DEF-020…DEF-023）。见
> [`../meta/decisions/adr-meta-layer-split.md`](../meta/decisions/adr-meta-layer-split.md)。
>
> | ID | 术语 |
> |----|------|
> | [DEF-020](../meta/glossary.md#DEF-020) | POC |
> | [DEF-021](../meta/glossary.md#DEF-021) | 晋升（Promote） |
> | [DEF-022](../meta/glossary.md#DEF-022) | Topic Binder |
> | [DEF-023](../meta/glossary.md#DEF-023) | Commit Ledger |
