...
## DEF: GraphStructure {#OBS-DEF-001}
...
## DEF: CSR (Compressed Sparse Row) {#OBS-DEF-008}
<!-- ndf: kind=def layer=L2 status=stable since=0.1 source=observed -->
