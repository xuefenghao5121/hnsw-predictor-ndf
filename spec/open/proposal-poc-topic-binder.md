...
| 位置 | ID | 动作 |
|------|-----|------|
| `20-behavior/process.md` | BEH-025 | 新增主题装订纪律 |
| `20-behavior/process.md` | BEH-018..020 | 补丁引用装订器 |
| `10-architecture/modules.md` | ARCH-008 | 声明 `poc/*/ndf` |
| `00-charter/glossary.md` | DEF-022, DEF-023 | Topic Binder / Commit Ledger |
| `AGENTS.md` / `poc/README.md` / `ndf.yaml` | — | 指挥与目录说明 |
| `tools/ndf/ndf_index.py` | — | `--poc-topics` |
