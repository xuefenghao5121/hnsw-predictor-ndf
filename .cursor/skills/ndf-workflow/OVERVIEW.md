...
> **入口**：`/ndf-workflow`（`.cursor/skills/ndf-workflow/`）  
> **权威**：`AGENTS.md` + `spec/meta/`  
> **配套 Canvas**：`~/.cursor/projects/home-huawei-hnsw-predictor-ndf/canvases/ndf-workflow-overview.canvas.tsx`  
> **日期**：2026-08-24  
...
| 层 | 谁 | 做什么 |
|----|-----|--------|
| 指挥面 | Cursor + `ndf-workflow` | 五句口令、等人审、造 pack、报 blockers |
