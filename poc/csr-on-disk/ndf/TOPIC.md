...
压缩 RSS（SIFT1M: -47MB, 100M: -4.7GB），验证性能影响。

## 背景

当前 CSR compact 常驻内存（SIFT1M: 47MB, 占 RSS 19.4%）。
100M 规模下 CSR 将达 4.7GB，是内存瓶颈（[[DEC-010]]、[[CHR-001]] P3）。
...
| R1 | 性能影响分析 (mincore, majfault, I/O 量) | 瓶颈定位 |
