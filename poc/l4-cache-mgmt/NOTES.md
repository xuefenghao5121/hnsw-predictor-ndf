...
> status: closed (mirrors TOPIC; subsets promoted — WILLNEED / BG-merge)
> close: promote/partial + topic closed | 2026-08 | see TOPIC / DEC-070 / DEC-074 / DEC-075
> 提案: `spec/open/proposal-l4-cache-mgmt.md`（Implemented）
> 条款: [[BEH-024]]（Trunk stable；本 NOTES 非 must）
