...
| ID | In spec/? | Notes |
|----|-----------|-------|
| [[BEH-024]] | yes (`status=stable`) | L4 主动管理；禁 EVICT 幽灵 |
...
## R2 阶段: 基于当前 Trunk 重新探索 (2026-08-05 amend)

> 提案: `spec/open/proposal-l4-cache-r2.md`
> 旧 R0-R5d 基线 stale (Trunk 大幅变更: FVC 默认值, race fix, WILLNEED_BG, VL_POOL)
