...
> **注**: 以下 200q 数据为 cache-warmed 场景 ([[CON-SLA-019]], [[DEC-083]])。
> 生产 I/O bound 场景 (10Kq) 见下方 sustained 表。

| 配置 | 指标 | 目标 | 200q (cache-warmed) |
|------|------|------|-------|
...
**Sustained I/O bound (10K random query, [[CON-SLA-020]]):**

| 配置 | Baseline QPS | +LEARNED_EF | recall |
|------|-------------|------------|--------|
| 512MB 4T | 4,129 | 6,324 (+53%) | 97.3% |
| 512MB 16T | 5,583 | 11,149 (+100%) | 97.3% |
| 256MB 4T | 2,341 | 4,418 (+89%) | 97.3% |
| 256MB 16T | 2,099 | 4,707 (+124%) | 97.3% |
| hnswlib 16T (739MB) | 41,839 | — | 99.5% |
