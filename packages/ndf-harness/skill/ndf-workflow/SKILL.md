...
| 层 | 谁 | 做什么 |
|----|----|--------|
| **指挥面** | 本 skill（Command Agent） | 听五句口令、分流 Idea、等人审、造 pack、调 CLI、报告 blockers / 写根 / 磁盘结果 |
...
Init/adopt/govern/sync：[install.md](install.md) / [adopt.md](adopt.md) / [govern.md](govern.md) / [sync.md](sync.md)。
